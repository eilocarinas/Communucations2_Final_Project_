...
# contains message and tracks 
# 00-sixteenth  01- eighth  10-quarter 11-half


part1_message = "10010110100101010101100101100101101001010101001010"
part1_message_long = "11111111111111111111111111111111111111111111111111"

part2_message = "01000101000100010001000100010010010001010001000100010000000000000010"
part2_message_long = "11111111111111111111111111111111111111111111111111111111111111111111"

part3_message = "01010110101010010101011001010110101001011001"
part3_message_long = "11111111111111111111111111111111111111111111"



part1_note = ['C0', 'B7', 'B8', 'G4',  # Ba-yang Ma-gi-
...
####################################################################################
part2_note = [ "G4","Gb4", "G4","A4","A4","D4","D4",  # Sa da-gat at bun-dok sa
                'A4','A4','D4','D4',                  # si-moy at sa
                'B4', 'C5', 'D5', 'E5','D5',          # la-ngit mong bug-haw
                'G4','Gb4', 'G4','A4','A4','D4','D4', # may di-lag ang tu-la at
                'A4','A4','D4','D4',                  # a-wit sa
                'B4','C5','B4','A4','B4','A4','G4'    # pag-la-yang mi-na-ma-hal
               ]

part2_note_f = [ "G4","Gb4", "G4","A4","A4","D4","D4",  # Sa da-gat at bun-dok sa
                'A4','A4','D4','D4',                  # si-moy at sa
                'B4', 'C5', 'D5', 'E5','D5',          # la-ngit mong bug-haw
                'G4','Gb4', 'G4','A4','A4','D4','D4', # may di-lag ang tu-la at
                'A4','A4','D4','D4',                  # a-wit sa
...
####################################################################################
part3_note = ['G4', 'E4', 'G4', 'C5',  # A-ming li-ga
                'C5', 'D5', 'D5', 'E5',  # ya na 'pag may
                'D5', 'C5', 'D5', 'E5',  # mang-a-a-pi
                'F5', 'E5', 'D5', 'E5',  # Ang ma-ma-tay
                'C5', 'D5', 'B4', 'B4', 'C5', 'rest'  # nang da-hil sa-'yo
                ]

part3_note_f = ['G4', 'E4', 'G4', 'C5',  # A-ming li-ga
                'C5', 'D5', 'D5', 'E5',  # ya na 'pag may
                'D5', 'C5', 'D5', 'E5',  # mang-a-a-pi
                'F5', 'E5', 'D5', 'E5',  # Ang ma-ma-tay
                'C5', 'D5', 'B4', 'B4', 'C5', 'rest'  # nang da-hil sa-'yo
